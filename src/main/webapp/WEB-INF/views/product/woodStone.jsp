...
<section class ="imgSection">
  <div class = cartItem>
  <img class = "productexplain" src="../resource/image//목화형 일체형 장식.png" alt="홀더"> 
  </div>
  <section>
  <div class="imagination">
    ...
    <li>판매가 : ₩150,000</li>
    <li>
      <p>유목으로 만들어져 내구도가 좋습니다. <br>
        품질 보증된 나무원단 제품을 싼 가격에 팝니다. <br><br>
        매일 목석이 부려져서 물품 구매 비용에 부담이 되시는 분, <br>
      ...
      <li><span>총 금액: ₩<span id="totalPrice">150,000</span></span></li>
