...
<section class ="imgSection">
  <div class = cartItem>
  <img class = "productexplain" src="../resource/image//SM 일체형 수조.png" alt="홀더"> 
  </div>
  <section>
  <div class="imagination">
    ...
    <li>판매가 : ₩250,000</li>
    <li>
      <p>강화유리로 만들어져 내구도가 좋습니다. <br>
        품질 보증된 회사의 제품을 싼 가격에 팝니다. <br><br>
        투명도도 맑아서 관상어를 관찰하기  좋은 제품입니다. <br>
        여러 물고기를 키우시면서, 튼튼하고 깨끗한 수조를 원하시는 분께 추천 드립니다. <br><br><br><br><br>
      ...
      <li><span>총 금액: ₩<span id="totalPrice">250,000</span></span></li>
