...
<section class ="imgSection">
  <div class = cartItem> 
  <img class = "productexplain"src="../resource/image//금룡아로와나.png" alt="홀더"> 
  </div> 
  <section>
  <div class="imagination">
    ...
    <li>판매가 : ₩2,500,000</li>
    <li>
      <p>홍룡,청룡,금룡 중 금룡입니다. <br>
        중국에서 매우 유명한 종으로, 부자들이 과시용으로 키우던 용 입니다. <br><br>
        물고기 이지만, 용을 닮아 그런 별명이 붙여졌습니다.<br>
        집에 아름다운 용 한 마리 들여보세요. <br>
        금룡을 재물을 상징하며, 돈 복이 들어온다고 합니다.<br><br><br><br>
      ...
      <li><span>총 금액: ₩<span id="totalPrice">2,500,000</span></span></li>
 <jsp:include page="/WEB-INF/views/include/productbag.jsp"></jsp:include>
  </ol>
  </div>
  <br><br><br>
