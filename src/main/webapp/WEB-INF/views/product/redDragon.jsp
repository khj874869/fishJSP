...
<section class ="imgSection">
  ...
  <img class = "productexplain" src="../resource/image//홍룡.png" alt="홀더"> 
  </div>
  <section>
  <div class="imagination">
    ...
    <li>판매가 : ₩2,000,000</li>
    <li>
      <p>청룡과 금룡에 이은 홍룡 입니다. <br>
        3용 중 하나로 건강을 관장한다고 합니다. <br><br>
        보통 중국 부자들은 홍룡과 금룡을 많이 키우는데, 이는 건강과 재물을 뜻 하기 때문입니다. <br>
        홍룡을 키우시고 싶다면 구매 추천드립니다. <br><br><br><br><br>
      ...
      <li><span>총 금액: ₩<span id="totalPrice">2,000,000</span></span></li>
